...
function initThree(){
  ...
  hemiLight = new THREE.HemisphereLight(0xa8bcd8, 0x4a3f30, 0.95);
  scene.add(hemiLight);
  ...
  ambLight = new THREE.AmbientLight(0x8a94ac, 0.32);
  scene.add(ambLight);
  sunLight = new THREE.DirectionalLight(0xffe8c0, 1.29);
...
const REGIONS = [
  { id:'village', name:'ASHEN VILLAGE', sub:'The Hearth is Cold', idx:0,
    ...
    fogColor:0x8a7962, fogD:0.0044, hemi:[0xa89880,0x4a4038,0.80], sun:0xffca8a, sunI:0.80, sky:0x4e463a,
    ground:0x7d7160, rock:0x8b8277, acc:[0xff8a3d,0xffd070], amb:0.26,
  ...
  { id:'forest', name:'WHISPERING FOREST', sub:'Where Roots Remember', idx:1,
    ...
    fogColor:0x6d9478, fogD:0.0034, hemi:[0x9fc4a8,0x3f4a38,0.82], sun:0xcfe8c0, sunI:0.70, sky:0x4a6350,
  ...
  { id:'mines', name:'FORGOTTEN MINES', sub:'Digging Toward the Dark', idx:2,
    ...
    fogColor:0x7d6748, fogD:0.0060, hemi:[0xa8926a,0x3a3020,0.78], sun:0xffb877, sunI:0.62, sky:0x403624,
    ground:0x6f6350, rock:0x7d7362, acc:[0xffb040,0xff8030], amb:0.28,
  ...
  { id:'caverns', name:'CRYSTAL CAVERNS', sub:'Light Beneath the World', idx:3,
    ...
    fogColor:0x466a8c, fogD:0.0072, hemi:[0x8fc4e8,0x1c2836,0.88], sun:0x88c8ff, sunI:0.55, sky:0x28374f,
    ground:0x46587a, rock:0x5f7a9a, acc:[0x5fd0e8,0x8f7ad8], amb:0.30,
  ...
  { id:'cathedral', name:'FROZEN CATHEDRAL', sub:'A Prayer Held in Ice', idx:4,
    ...
    fogColor:0xa8bccd, fogD:0.0046, hemi:[0xdfeaf7,0x5a6472,0.82], sun:0xdceaff, sunI:0.72, sky:0x6e7f92,
    ground:0xc3d3e2, rock:0xa8bccf, acc:[0xdff0ff,0x7fd8ff], amb:0.30,
  ...
  { id:'citadel', name:'SCORCHED CITADEL', sub:'The Throne of Cinders', idx:5,
    ...
    fogColor:0xb0714a, fogD:0.0038, hemi:[0xc08050,0x4a2818,0.90], sun:0xffb070, sunI:0.78, sky:0x6e3a24,
    ground:0x7d5f49, rock:0x8f7059, acc:[0xff7a2a,0xffd070], amb:0.34,
  ...
  { id:'sunforge', name:'THE SUN FORGE', sub:'Where Light Was Made', idx:6,
    ...
    fogColor:0xa8894c, fogD:0.0046, hemi:[0xffe8b8,0x6a4a20,0.88], sun:0xfff0c0, sunI:0.82, sky:0x6e5734,
    ground:0x977d52, rock:0xab9068, acc:[0xffd070,0xffb040], amb:0.32,
